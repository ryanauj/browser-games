    ...
    <div className="cc-modal" role="dialog" aria-modal="true" aria-label="How to play">
      <div className="cc-modal__card cc-help">
        ...
        <p className="cc-help__lead">
          Half-court 5v5. You direct all five of your players, <strong>one beat at a time</strong>.
        </p>
        ...
        <div className="cc-help__quick">
          ...
          <ol>
            ...
            <li>
              Set your orders (they stick until you change them), then press <em>▶ Next Beat</em>. Nothing moves
              until you do.
            </li>
            <li>
        ...
        <p className="cc-help__sec">
          ...
          reach this beat; the dashed outer ring is the farther <em>cut/drive</em> burst — more ground, more stamina.
        </p>
        ...
        <p className="cc-help__sec">
          ...
          every beat. It recovers each possession.
        </p>
