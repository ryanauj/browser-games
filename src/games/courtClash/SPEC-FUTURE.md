...
>
> **Priority (set 2026-06-14):** Cluster **A is the near-term direction** —
> start once 2.0 gameplay is dialed in. Cluster **B (roster economy / contracts)
> is deferred until much later**, after the core gameplay feels right; it's
> recorded here so the design is ready, not because it's next.
>
...
## B. Roster economy — the "value GM" meta  *(deferred — much later)*

> Not started until the core gameplay feels right. Captured now so the design is
> ready when we come back to it.
